# -*- coding: utf-8 -*-
#
# python-cybox documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'cybox.utils.autoentity', 'sphinx.ext.ifconfig']
...
man_pages = [
    ('index', 'python-cybox', u'python-cybox Documentation',
...
texinfo_documents = [
  ('index', 'python-cybox', u'python-cybox Documentation',
   u'The MITRE Corporation', 'python-cybox', 'One line description of project.',
   'Miscellaneous'),
]
