...
OBJECTS = {
            ...
            "ArtifactObjectType": 'cybox.objects.artifact_object.Artifact',
...
class NamespaceParser(object):
    ...
    DEFINED_OBJECTS_DICT = {'AccountObjectType' : {'binding_name' : 'account_object', 'namespace_prefix' : 'AccountObj', 'namespace' : 'http://cybox.mitre.org/objects#AccountObject-2', 'schemalocation' : 'http://cybox.mitre.org/XMLSchema/objects/Account/2.0/Account_Object.xsd'},
                   ...
                   'ArtifactObjectType' : {'binding_name' : 'artifact_object', 'namespace_prefix' : 'ArtifactObj', 'namespace' : 'http://cybox.mitre.org/objects#ArtifactObject-2', 'schemalocation' : 'http://cybox.mitre.org/XMLSchema/objects/Artifact/2.0/Artifact_Object.xsd'},
