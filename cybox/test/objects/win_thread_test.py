...
class TestWinThread(unittest.TestCase, ObjectTestCase):
    ...
    def test_round_trip(self):
        thread_dict = {
                        ...
                        'stack_size': 0x1000,
                        'xsi:type': 'WindowsThreadObjectType'
                      }
        thread_dict2 = cybox.test.round_trip_dict(WinThread, thread_dict)
        self.maxDiff = None
        self.assertEqual(thread_dict, thread_dict2)
