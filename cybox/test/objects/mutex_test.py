...
class MutexTest(unittest.TestCase):
    def setUp(self):
        self.test_dict = {'named' : {'value' : True}, 'name' : {'value' : 'test_name'}}
        self.mutex_obj = mutex_object.object_from_dict(self.test_dict)
        self.mutex_dict = mutex_object.dict_from_object(self.mutex_obj)
    ...
    def test_obj_from_dict(self):
        ...
        self.assertIsInstance(self.mutex_obj.get_Name(), common_types_binding.StringObjectAttributeType)
    ...
    def test_dict_from_obj(self):
        ...
        self.assertEqual(self.mutex_dict['named']['value'], True)
