...
class TestWinUser(unittest.TestCase, ObjectTestCase):
    object_type = "WindowsUserAccountObjectType"
    klass = WinUser

    def test_round_trip(self):
        sid = u"S-1-5-21-3623811015-3361044348-30300820-1013"
        winuser_dict = {
        ...
        winuser_dict2 = cybox.test.round_trip_dict(WinUser, winuser_dict)
        self.assertEqual(winuser_dict, winuser_dict2)
