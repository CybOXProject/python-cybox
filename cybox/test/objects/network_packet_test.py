...
class TestEthernetInterface(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        iface_dict2 = cybox.test.round_trip_dict(EthernetInterface, iface_dict)
        self.assertEqual(iface_dict, iface_dict2)
...
class TestARP(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        arp_dict2 = cybox.test.round_trip_dict(ARP, arp_dict)
        self.maxDiff = None
        self.assertEqual(arp_dict, arp_dict2)
...
class TestNDPSrcLinkAddr(unittest.TestCase):

    def test_round_trip(self):
        addr_dict2 = cybox.test.round_trip_dict(NDPSrcLinkAddr, ADDR_DICT)
        self.assertEqual(ADDR_DICT, addr_dict2)


class TestNDPTargetLinkAddr(unittest.TestCase):

    def test_round_trip(self):
        addr_dict2 = cybox.test.round_trip_dict(NDPTargetLinkAddr, ADDR_DICT)
        self.assertEqual(ADDR_DICT, addr_dict2)


class TestNDPPrefixInfo(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        prefix_dict2 = cybox.test.round_trip_dict(NDPPrefixInfo, prefix_dict)
        self.assertEqual(prefix_dict, prefix_dict2)
...
class TestNDP(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        ndp_dict2 = cybox.test.round_trip_dict(NDP, ndp_dict)
        self.maxDiff = None
        self.assertEqual(ndp_dict, ndp_dict2)


class TestIPv4Packet(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        packet_dict2 = cybox.test.round_trip_dict(IPv4Packet, packet_dict)
        self.maxDiff = None
        self.assertEqual(packet_dict, packet_dict2)
...
class TestICMPv4(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        packet_dict2 = cybox.test.round_trip_dict(ICMPv4Packet, packet_dict)
        self.maxDiff = None
        self.assertEqual(packet_dict, packet_dict2)
...
class TestIPv6(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        packet_dict2 = cybox.test.round_trip_dict(IPv6Packet, packet_dict)
        self.maxDiff = None
        self.assertEqual(packet_dict, packet_dict2)
...
class TestICMPv6(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        packet_dict2 = cybox.test.round_trip_dict(ICMPv6Packet, packet_dict)
        self.maxDiff = None
        self.assertEqual(packet_dict, packet_dict2)
...
class TestTCP(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        packet_dict2 = cybox.test.round_trip_dict(TCP, packet_dict)
        self.maxDiff = None
        self.assertEqual(packet_dict, packet_dict2)
...
class TestUDP(unittest.TestCase):
    ...
    def test_round_trip(self):
        ...
        packet_dict2 = cybox.test.round_trip_dict(UDP, packet_dict)
        self.maxDiff = None
        self.assertEqual(packet_dict, packet_dict2)
