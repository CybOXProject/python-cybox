...
class TestWinTask(unittest.TestCase, ObjectTestCase):
    ...
    def test_round_trip(self):
        task_dict = {
                        ...
                        'xsi:type': 'WindowsTaskObjectType',
                    }
        task_dict2 = cybox.test.round_trip_dict(WinTask, task_dict)
        self.maxDiff = None
        self.assertEqual(task_dict, task_dict2)
