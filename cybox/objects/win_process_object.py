...
import cybox.win_process_object_1_3 as cybox_win_process_object
...
class win_process_object:
    ...
    def build_object(self, process_attributes):
        ...
        proc_object = cybox_win_process_object.WindowsProcessObjectType()
        proc_object.set_anyAttributes_({'xsi:type' : 'WinProcessObj:WindowsProcessObjectType'})
        section_list = cybox_win_process_object.MemorySectionListType()
