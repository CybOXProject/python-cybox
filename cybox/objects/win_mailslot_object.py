...
class win_mailslot_object:
    ...
    @classmethod
    def create_from_dict(cls, mailslot_attributes):
        ...
        for key, value in mailslot_attributes.items():
            if key == 'name' and common_methods.test_value(value):
                mailslot_obj.set_Name(baseobjectattribute.create_from_dict(common_types_binding.StringObjectAttributeType(datatype='String'),value))
            elif key == 'max_message_size' and common_methods.test_value(value):
                mailslot_obj.set_Max_Message_Size(baseobjectattribute.create_from_dict(common_types_binding.NonNegativeIntegerObjectAttributeType(datatype='NonNegativeInteger'),value))
            elif key == 'read_timeout' and common_methods.test_value(value):
                mailslot_obj.set_Read_Timeout(baseobjectattribute.create_from_dict(common_types_binding.NonNegativeIntegerObjectAttributeType(datatype='NonNegativeInteger'),value))
            elif key == 'security_attributes' and common_methods.test_value(value):
                mailslot_obj.set_Security_Attributes(baseobjectattribute.create_from_dict(common_types_binding.StringObjectAttributeType(datatype='String'),value))
            elif key == 'handle':
    ...
    def parse_into_dict(cls, defined_object):
        ...
        if defined_object.get_Max_Message_Size() is not None: defined_object_dict['max_message_size'] = baseobjectattribute.parse_into_dict(defined_object.get_Max_Message_Size())
        ...
        if defined_object.get_Read_Timeout() is not None: defined_object_dict['read_timeout'] = baseobjectattribute.parse_into_dict(defined_object.get_Read_Timeout())
