    ...
    def __parse_http_client_request(cls, http_client_request):
        ...
        if http_client_request.get_HTTP_Request_Line() is not None:
            ...
            if client_request_line.get_HTTP_Method() is not None:
                client_request_line_dict['http_method'] = baseobjectattribute.dict_from_object(client_request_line.get_HTTP_Method())
            if client_request_line.get_Value() is not None:
                client_request_line_dict['value'] = baseobjectattribute.dict_from_object(client_request_line.get_HTTP_Value())
            if client_request_line.get_Version() is not None:
                client_request_line_dict['version'] = baseobjectattribute.dict_from_object(client_request_line.get_Version())
        ...
        if http_client_request.get_HTTP_Request_Header() is not None:
            ...
            if request_header.get_Parsed_Header() is not None:
                ...
                parsed_header_dict = {}
                if parsed_header.get_Accept() is not None: parsed_header_dict['accept'] = baseobjectattribute.dict_from_object(parsed_header.get_Accept())
                if parsed_header.get_Accept_Charset() is not None: parsed_header_dict['accept-charset'] = baseobjectattribute.dict_from_object(parsed_header.get_Accept_Charset())
                if parsed_header.get_Accept_Language() is not None: parsed_header_dict['accept-language'] = baseobjectattribute.dict_from_object(parsed_header.get_Accept_Language())
                if parsed_header.get_Accept_Datetime() is not None: parsed_header_dict['accept-datetime'] = baseobjectattribute.dict_from_object(parsed_header.get_Accept_Datetime())
                if parsed_header.get_Accept_Encoding() is not None: parsed_header_dict['accept'] = baseobjectattribute.dict_from_object(parsed_header.get_Accept_Encoding())
                if parsed_header.get_Authorization() is not None: parsed_header_dict['authorization'] = baseobjectattribute.dict_from_object(parsed_header.get_Authorization())
                if parsed_header.get_Cache_Control() is not None: parsed_header_dict['cache-control'] = baseobjectattribute.dict_from_object(parsed_header.get_Cache_Control())
                if parsed_header.get_Connection() is not None: parsed_header_dict['connection'] = baseobjectattribute.dict_from_object(parsed_header.get_Connection())
                if parsed_header.get_Cookie() is not None: parsed_header_dict['cookie'] = baseobjectattribute.dict_from_object(parsed_header.get_Cookie())
                if parsed_header.get_Content_Length() is not None: parsed_header_dict['content-length'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Length())
                if parsed_header.get_Content_MD5() is not None: parsed_header_dict['content-md5'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_MD5())
                ...
                if parsed_header.get_If_Modified_Since() is not None: parsed_header_dict['if-modified-since'] = baseobjectattribute.dict_from_object(parsed_header.get_If_Modified_Since())
                if parsed_header.get_If_None_Match() is not None: parsed_header_dict['if-none-match'] = baseobjectattribute.dict_from_object(parsed_header.get_If_None_Match())
                if parsed_header.get_If_Range() is not None: parsed_header_dict['if-range'] =baseobjectattribute.dict_from_object( parsed_header.get_If_Range())
                if parsed_header.get_If_Unmodified_Since() is not None: parsed_header_dict['if-unmodified-since'] = baseobjectattribute.dict_from_object(parsed_header.get_If_Unmodified_Since())
                if parsed_header.get_Max_Forwards() is not None: parsed_header_dict['max-forwards'] = baseobjectattribute.dict_from_object(parsed_header.get_Max_Forwards())
        ...
        if http_client_request.get_HTTP_Message_Body() is not None:
            ...
            message_body_dict = {}
            if message_body.get_Length() is not None: message_body_dict['length'] = baseobjectattribute.dict_from_object(message_body.get_Length())
            if message_body.get_Message_Body() is not None: message_body_dict['message_body'] = baseobjectattribute.dict_from_object(message_body.get_Message_Body())
    ...
    def __parse_http_server_response(cls, http_server_response):
        ...
        if http_server_response.get_HTTP_Status_Line() is not None:
            ...
            if server_status_line_dict.get_Version() is not None:
                server_status_line_dict['version'] = baseobjectattribute.dict_from_object(server_status_line.get_Version())
            if server_status_line_dict.get_Status_Code() is not None:
                server_status_line_dict['status_code'] = baseobjectattribute.dict_from_object(server_status_line.get_Status_Code())
            if server_status_line_dict.get_Reason_Phrase() is not None:
                server_status_line_dict['reason_phrase'] = baseobjectattribute.dict_from_object(server_status_line.get_Reason_Phrase())
        ...
        if http_server_response.get_HTTP_Response_Header() is not None:
            ...
            if response_header.get_Parsed_Header() is not None:
                ...
                parsed_header_dict = {}
                if parsed_header.get_Access_Control_Allow_Origin() is not None: parsed_header_dict['access-control-allow-origin'] = baseobjectattribute.dict_from_object(parsed_header.get_Access_Control_Allow_Origin())
                if parsed_header.get_Accept_Ranges() is not None: parsed_header_dict['accept-ranges'] = baseobjectattribute.dict_from_object(parsed_header.get_Accept_Ranges())
                if parsed_header.get_Age() is not None: parsed_header_dict['age'] = baseobjectattribute.dict_from_object(parsed_header.get_Age())
                if parsed_header.get_Cache_Control() is not None: parsed_header_dict['cache-control'] = baseobjectattribute.dict_from_object(parsed_header.get_Cache_Control())
                if parsed_header.get_Connection() is not None: parsed_header_dict['connection'] = baseobjectattribute.dict_from_object(parsed_header.get_Connection())
                if parsed_header.get_Content_Encoding() is not None: parsed_header_dict['content-encoding'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Encoding())
                if parsed_header.get_Content_Language() is not None: parsed_header_dict['content-language'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Language())
                if parsed_header.get_Content_Length() is not None: parsed_header_dict['content-length'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Length())
                if parsed_header.get_Content_Location() is not None: parsed_header_dict['content-location'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Location())
                if parsed_header.get_Content_MD5() is not None: parsed_header_dict['content-md5'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_MD5())
                if parsed_header.get_Content_Disposition() is not None: parsed_header_dict['content-disposition'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Disposition())
                if parsed_header.get_Content_Range() is not None: parsed_header_dict['content-range'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Range())
                if parsed_header.get_Content_Type() is not None: parsed_header_dict['content-type'] = baseobjectattribute.dict_from_object(parsed_header.get_Content_Type())
                if parsed_header.get_Date() is not None: parsed_header_dict['date'] = baseobjectattribute.dict_from_object(parsed_header.get_Date())
                if parsed_header.get_ETag() is not None: parsed_header_dict['etag'] = baseobjectattribute.dict_from_object(parsed_header.get_ETag())
                ...
                if parsed_header.get_Refresh() is not None: parsed_header_dict['refresh'] = baseobjectattribute.dict_from_object(parsed_header.get_Refresh())
                if parsed_header.get_Retry_After() is not None: parsed_header_dict['retry-after'] = baseobjectattribute.dict_from_object(parsed_header.get_Retry_After())
                if parsed_header.get_Server() is not None: parsed_header_dict['server'] = baseobjectattribute.dict_from_object(parsed_header.get_Server())
                if parsed_header.get_Set_Cookie() is not None: parsed_header_dict['set-cookie'] = baseobjectattribute.dict_from_object(parsed_header.get_Set_Cookie())
                ...
                if parsed_header.get_X_Frame_Options() is not None: parsed_header_dict['x-frame-options'] = baseobjectattribute.dict_from_object(parsed_header.get_X_Frame_Options())
                if parsed_header.get_X_XSS_Protection() is not None: parsed_header_dict['x-xss-protection'] = baseobjectattribute.dict_from_object(parsed_header.get_X_XSS_Protection())
                if parsed_header.get_X_Content_Type_Options() is not None: parsed_header_dict['x-content-type-options'] = baseobjectattribute.dict_from_object(parsed_header.get_X_Content_Type_Options())
                if parsed_header.get_X_Forwarded_Proto() is not None: parsed_header_dict['x-forwarded-proto'] = baseobjectattribute.dict_from_object(parsed_header.get_X_Forwareded_Proto())
                if parsed_header.get_X_Powered_By() is not None: parsed_header_dict['x-powered-by'] = baseobjectattribute.dict_from_object(parsed_header.get_X_Powered_By())
                if parsed_header.get_X_UA_Compatible() is not None: parsed_header_dict['x-ua-compatible'] = baseobjectattribute.dict_from_object(parsed_header.get_X_UA_Compatible())
