    ...
    def __parse_link_layer(cls, link_layer):
            ...
            if physical_interface.get_Ethernet() is not None:
                ...
                if ethernet.get_Ethernet_Header() is not None:
                    ...
                    if ethernet_header.get_Type_Or_Length() is not None:
                        ...
                        type_or_length_dict = {}
                        if type_or_length.get_Length() is not None: type_or_length_dict['length'] = baseobjectattribute.dict_from_object(type_or_length.get_Length())
                        if type_or_length.get_Internet_Layer_Type() is not None: type_or_length_dict['internet_layer_type'] = baseobjectattribute.dict_from_object(type_or_length.get_Internet_Layer_Type())
                        ethernet_header_dict['type_or_length'] = type_or_length_dict
                    if ethernet_header.get_Checksum() is not None: ethernet_header['checksum'] = baseobjectattribute.dict_from_object(ethernet_header.get_Checksum())
        ...
        if link_layer.get_Logical_Protocols() is not None:
            ...
            if logical_protocols.get_ARP_RARP() is not None:
                ...
                arp_rarp_dict = {}
                if arp_rarp.get_Hardware_Addr_Type() is not None: arp_rarp_dict['hardware_addr_type'] = baseobjectattribute.dict_from_object(arp_rarp.get_Hardware_Addr_Type())
                if arp_rarp.get_Proto_Addr_Type() is not None: arp_rarp_dict['proto_addr_type'] = baseobjectattribute.dict_from_object(arp_rarp.get_Proto_Addr_Type())
            ...
            if logical_protocols.get_NDP() is not None:
                ...
                if ndp.get_ICMPv6_Header() is not None:
                    ...
                    icmp_header_dict = {}
                    if icmp_header.get_Type() is not None: icmp_header_dict['type'] = baseobjectattribute.dict_from_object(icmp_header.get_Type())
                    if icmp_header.get_Code() is not None: icmp_header_dict['code'] = baseobjectattribute.dict_from_object(icmp_header.get_Code())
                    if icmp_header.get_Checksum() is not None: icmp_header_dict['checksum'] = baseobjectattribute.dict_from_object(icmp_header.get_Checksum())
                ...
                if ndp.get_Router_Advertisement() is not None:
                    ...
                    if router_advertisement.get_Cur_Hop_Limit() is not None: router_advertisement_dict['cur_hop_limit'] = baseobjectattribute.dict_from_object(router_advertisement.get_Cur_Hop_Limit())
                    if router_advertisement.get_Router_Lifetime() is not None: router_advertisement_dict['router_lifetime'] = baseobjectattribute.dict_from_object(router_advertisement.get_Router_Lifetime())
                    if router_advertisement.get_Reachable_Time() is not None: router_advertisement_dict['reachable_time'] = baseobjectattribute.dict_from_object(router_advertisement.get_Reachable_Time())
                    if router_advertisement.get_Retrans_Timer is not None: router_advertisement_dict['retrans_timer'] = baseobjectattribute.dict_from_object(router_advertisement.get_Retrans_Timer())
                    if router_advertisement.get_Options() is not None:
                        ...
                        if options.get_MTU() is not None:
                            mtu = options.get_MTU()
                            mtu_dict = {}
                            if mtu.get_Length() is not None: mtu_dict['length'] = baseobjectattribute.dict_from_object(mtu.get_Length())
                            if mtu.get_MTU() is not None: mtu_dict['mtu'] = baseobjectattribute.dict_from_object(mtu.get_MTU())
                        ...
                        if options.get_Prefix_Info() is not None:
                            ...
                            if prefix_info.get_Length() is not None: prefix_info_dict['length'] = baseobjectattribute.dict_from_object(prefix_info.get_Length())
                            if prefix_info.get_Prefix_Length() is not None: prefix_info_dict['prefix_length'] = baseobjectattribute.dict_from_object(prefix_info.get_Prefix_Length())
                            if prefix_info.get_Valid_Lifetime() is not None: prefix_info_dict['valid_lifetime'] = baseobjectattribute.dict_from_object(prefix_info.get_Valid_Lifetime())
                            if prefix_info.get_Preferred_Lifetime() is not None: prefix_info_dict['preferred_lifetime'] = baseobjectattribute.dict_from_object(prefix_info.get_Preferred_Lifetime())
                ...
                if ndp.get_Redirect() is not None:
                    ...
                    if redirect.get_Options() is not None:
                        ...
                        if options.get_Redirected_Header() is not None:
                            ...
                            if redirected_header.get_Length() is not None: redirected_header_dict['length'] = baseobjectattribute.dict_from_object(redirected_header.get_Length())
                            if redirected_header.get_IPHeader_And_Data() is not None: redirected_header_dict['ipheader_and_data'] = baseobjectattribute.dict_from_object(redirected_header.get_IPHeader_And_Data())
    ...
    def __parse_internet_layer(cls, internet_layer):
        ...
        if internet_layer.get_IPv4() is not None:
            ...
            if ipv4.get_IPv4_Header() is not None:
                ...
                ipv4_header_dict = {}
                if ipv4_header.get_IP_Version() is not None: ipv4_header_dict['ip_version'] = baseobjectattribute.dict_from_object(ipv4_header.get_IP_Version())
                if ipv4_header.get_Header_Length() is not None: ipv4_header_dict['header_length'] = baseobjectattribute.dict_from_object(ipv4_header.get_Header_Length())
                if ipv4_header.get_DSCP() is not None: ipv4_header_dict['dscp'] = baseobjectattribute.dict_from_object(ipv4_header.get_DSCP())
                if ipv4_header.get_ECN() is not None: ipv4_header_dict['ecn'] = baseobjectattribute.dict_from_object(ipv4_header.get_ECN())
                if ipv4_header.get_Total_Length() is not None: ipv4_header_dict['total_length'] = baseobjectattribute.dict_from_object(ipv4_header.get_Total_Length())
                if ipv4_header.get_Identification() is not None: ipv4_header_dict['identification'] = baseobjectattribute.dict_from_object(ipv4_header.get_Identification())
                if ipv4_header.get_Flags() is not None:
                    flags = ipv4_header.get_Flags()
                    flags_dict = {}
                    if flags.get_Reserved() is not None: flags_dict['reserved'] = baseobjectattribute.dict_from_object(flags.get_Reserved())
                    if flags.get_Do_Not_Fragment() is not None: flags_dict['do_not_fragment'] = baseobjectattribute.dict_from_object(flags.get_Do_Not_Fragment())
                    if flags.get_More_Fragments() is not None: flags_dict['more_fragments'] = baseobjectattribute.dict_from_object(flags.get_More_Fragments())
                    ipv4_header_dict['flags'] = flags_dict
                if ipv4_header.get_Fragment_Offset() is not None: ipv4_header_dict['fragment_offset'] = baseobjectattribute.dict_from_object(ipv4_header.get_Fragment_Offset())
                ...
                if ipv4_header.get_Option() is not None:
                    ...
                    for option in ipv4_header.get_Option():
                        option_dict = {}
                        if option.get_Copy_Flag() is not None: option_dict['copy_flag'] = baseobjectattribute.dict_from_object(option.get_Copy_Flag())
                        if option.get_Class() is not None: option_dict['class'] = baseobjectattribute.dict_from_object(option.get_Class())
                        if option.get_Option() is not None: option_dict['option'] = baseobjectattribute.dict_from_object(option.get_Option())
                        options.append(option_dict)
                    ipv4_header_dict['options'] = options
                ipv4_dict['ipv4_header'] = ipv4_header_dict
            if ipv4.get_Data() is not None: ipv4_dict['data'] = baseobjectattribute.dict_from_object(ipv4.get_Data())
        ...
        if internet_layer.get_ICMPv4() is not None:
            ...
            if icmpv4.get_ICMPV4_Header() is not None:
                ...
                icmpv4_header_dict = {} 
                if icmpv4_header.get_Type() is not None: icmpv4_header_dict['type'] = baseobjectattribute.dict_from_object(icmpv4_header.get_Type())
                if icmpv4_header.get_Code() is not None: icmpv4_header_dict['code'] = baseobjectattribute.dict_from_object(icmpv4_header.get_Code())
                if icmpv4_header.get_Checksum() is not None: icmpv4_header_dict['checksum'] = baseobjectattribute.dict_from_object(icmpv4_header.get_Checksum())
            ...
            if icmpv4.get_Error_Msg() is not None:
                ...
                if error_msg.get_Destination_Unreachable() is not None:
                    ...
                    if dest_unreachable.get_Fragmentation_Required() is not None:
                        ...
                        if frag_required.get_Next_Hop_MTU() is not None: frag_required_dict['next_hop_mtu'] = baseobjectattribute.dict_from_object(frag_required.get_Next_Hop_MTU())
            ...
            if icmpv4.get_Info_Msg() is not None:
                ...
                if info_msg.get_Echo_Reply() is not None:
                    ...
                    if echo_reply.get_Data() is not None: echo_reply_dict['data'] = baseobjectattribute.dict_from_object(echo_reply.get_Data())
                ...
                if info_msg.get_Echo_Request() is not None:
                    ...
                    if echo_request.get_Data() is not None: echo_request_dict['data'] = baseobjectattribute.dict_from_object(echo_request.get_Data())
                ...
                if info_msg.get_Timestamp_Request() is not None:
                    ...
                    if timestamp_request.get_Originate_Timestamp() is not None: timestamp_request_dict['originate_timestamp'] = baseobjectattribute.dict_from_object(timestamp_request.get_Originate_Timestamp())
                ...
                if info_msg.get_Timestamp_Reply() is not None:
                    ...
                    if timestamp_reply.get_Originate_Timestamp() is not None: timestamp_reply_dict['originate_timestamp'] = baseobjectattribute.dict_from_object(timestamp_reply.get_Originate_Timestamp())
                    if timestamp_reply.get_Receive_Timestamp() is not None: timestamp_reply_dict['receive_timestamp'] = baseobjectattribute.dict_from_object(timestamp_reply.get_Receive_Timestamp())
                    if timestamp_reply.get_Transmit_Timestamp() is not None: timestamp_reply_dict['transmit_timestamp'] = baseobjectattribute.dict_from_object(timestamp_reply.get_Transmit_Timestamp())
                ...
                if info_msg.get_Info_Msg_Content() is not None:
                    ...
                    if info_msg_content.get_Identifier() is not None: info_msg_content_dict['identifier'] = baseobjectattribute.dict_from_object(info_msg_content.get_Identifier())
                    if info_msg_content.get_Sequence_Number() is not None: info_msg_content_dict['sequence_number'] = baseobjectattribute.dict_from_object(info_msg_content.get_Sequence_Number())
            ...
            if icmpv4.get_Traceroute() is not None:
                ...
                if traceroute.get_Identifier() is not None: traceroute_dict['identifier'] = baseobjectattribute.dict_from_object(traceroute.get_Identifier())
                if traceroute.get_Outbound_Hop_Count() is not None: traceroute_dict['outbound_hop_count'] = baseobjectattribute.dict_from_object(traceroute.get_Outbound_Hop_Count())
                if traceroute.get_Return_Hop_Count() is not None: traceroute_dict['return_hop_count'] = baseobjectattribute.dict_from_object(traceroute.get_Return_Hop_Count())
                if traceroute.get_Output_Link_Speed() is not None: traceroute_dict['output_link_speed'] = baseobjectattribute.dict_from_object(traceroute.get_Output_Link_Speed())
                if traceroute.get_Output_Link_MTU() is not None: traceroute_dict['output_link_mtu'] = baseobjectattribute.dict_from_object(traceroute.get_Output_Link_MTU())
        ...
        if internet_layer.get_IPv6() is not None:
            ...
            if ipv6.get_IPv6_Header() is not None:
                ...
                if ipv6_header.get_Traffic_Class() is not None: ipv6_header_dict['traffic_class'] = baseobjectattribute.dict_from_object(ipv6_header.get_Traffic_Class())
                if ipv6_header.get_Flow_Label() is not None: ipv6_header_dict['flow_label'] = baseobjectattribute.dict_from_object(ipv6_header.get_Flow_Label())
            ...
            if ipv6.get_Ext_Headers() is not None:
                ...
                for ext_header in ipv6.get_Ext_Headers():
                    ...
                    if ext_header.get_Hop_by_Hop_Options() is not None:
                        ...
                        if hop_by_hop_options.get_Next_Header() is not None: hop_by_hop_options_dict['next_header'] = baseobjectattribute.dict_from_object(hop_by_hop_options.get_Next_Header())
                        if hop_by_hop_options.get_Header_Ext_Len() is not None: hop_by_hop_options_dict['header_ext_len'] = baseobjectattribute.dict_from_object(hop_by_hop_options.get_Header_Ext_Len())
                        if hop_by_hop_options.get_Option_Data() is not None:
                            ...
                            for option in hop_by_hop_options.get_Option_Data():
                                ...
                                if option.get_Option_Type() is not None: 
                                    ...
                                    option_type_dict = {}
                                    if option_type.get_Do_Not_Recogn_Action() is not None: option_type_dict['do_not_recogn_action'] = baseobjectattribute.dict_from_object(option_type.get_Do_Not_Recogn_Action())
                                    if option_type.get_Packet_Change() is not None: option_type_dict['packet_change'] = baseobjectattribute.dict_from_object(option_type.get_Packet_Change())
                                    if option_type.get_Option_Byte() is not None: option_type_dict['option_byte'] = baseobjectattribute.dict_from_object(option_type.get_Option_Byte())
                                    option_dict['option_type'] = option_type_dict
                                if option.get_Option_Data_Len() is not None: option_dict['option_data_len'] = baseobjectattribute.dict_from_object(option.get_Option_Data_Len())
                                if option.get_Pad1() is not None:
                                    pad1 = option.get_Pad1()
                                    pad1_dict = {}
                                    if pad1.get_Octet() is not None: pad1_dict['octet'] = baseobjectattribute.dict_from_object(pad1.get_Octet())
                                    option_dict['pad1'] = pad1_dict
                                if option.get_PadN() is not None:
                                    padn = option.get_PadN()
                                    padn_dict = {}
                                    if padn.get_Octet() is not None: padn_dict['octet'] = baseobjectattribute.dict_from_object(padn.get_Octet())
                                    if padn.get_Option_Data_Length() is not None: padn_dict['option_data_length'] = baseobjectattribute.dict_from_object(padn.get_Option_Data_Length())
                                    if padn.get_Option_Data() is not None: padn_dict['option_data'] = baseobjectattribute.dict_from_object(padn.get_Option_Data())
                    ...
                    if ext_header.get_Routing() is not None:
                        ...
                        routing_dict = {}
                        if routing.get_Next_Header() is not None: routing_dict['next_header'] = baseobjectattribute.dict_from_object(routing.get_Next_Header())
                        if routing.get_Header_Ext_Len() is not None: routing_dict['header_ext_len'] = baseobjectattribute.dict_from_object(routing.get_Header_Ext_Len())
                        if routing.get_Routing_Type() is not None: routing_dict['routing_type'] = baseobjectattribute.dict_from_object(routing.get_Routing_Type())
                        if routing.get_Segments_Left() is not None: routing_dict['segments_left'] = baseobjectattribute.dict_from_object(routing.get_Segments_Left())
                        if routing.get_Type_Specific_Data() is not None: routing_dict['type_specific_data'] = baseobjectattribute.dict_from_object(routing.get_Type_Specific_Data())
                    ...
                    if ext_header.get_Fragment() is not None:
                        ...
                        if fragment.get_Fragment_Header() is not None:
                            ...
                            if fragment_header.get_Next_Header() is not None: fragment_header_dict['next_header'] = baseobjectattribute.dict_from_object(fragment_header.get_Next_Header())
                            if fragment_header.get_Fragment_Offset() is not None: fragment_header_dict['fragment_offset'] = baseobjectattribute.dict_from_object(fragment_header.get_Fragment_Offset())
                            if fragment_header.get_M_Flag() is not None: fragment_header_dict['m_flag'] = baseobjectattribute.dict_from_object(fragment_header.get_M_Flag())
                            if fragment_header.get_Identification() is not None: fragment_header_dict['identification'] = baseobjectattribute.dict_from_object(fragment_header.get_Identification())
                            fragment_dict['fragment_header'] = fragment_header_dict
                        if fragment.get_Fragment() is not None: fragment_dict['fragment'] = baseobjectattribute.dict_from_object(fragment.get_Fragment())
                    ...
                    if ext_header.get_Destination_Options() is not None:
                        ...
                        for destination_option in ext_header.get_Destination_Options():
                            ...
                            if destination_option.get_Next_Header() is not None: destination_option_dict['next_header'] = baseobjectattribute.dict_from_object(destination_option.get_Next_Header())
                            if destination_option.get_Header_Ext_Len() is not None: destination_option_dict['header_ext_len'] = baseobjectattribute.dict_from_object(destination_option.get_Header_Ext_Len())
                    ...
                    if ext_header.get_Authentication_Header() is not None:
                        ...
                        if authentication_header.get_Next_Header() is not None: authentication_header_dict['next_header'] = baseobjectattribute.dict_from_object(authentication_header.get_Next_Header())
                        if authentication_header.get_Header_Ext_Len() is not None: authentication_header_dict['header_ext_len'] = baseobjectattribute.dict_from_object(authentication_header.get_Header_Ext_Len())
                        if authentication_header.get_Security_Parameters_Index() is not None: authentication_header_dict['security_parameters_index'] = baseobjectattribute.dict_from_object(authentication_header.get_Security_Parameters_Index())
                        if authentication_header.get_Sequence_Number() is not None: authentication_header_dict['sequence_number'] = baseobjectattribute.dict_from_object(authentication_header.get_Sequence_Number())
                        if authentication_header.get_Authenication_Data() is not None: authentication_header_dict['authenication_data'] = baseobjectattribute.dict_from_object(authentication_header.get_Authenication_Data())
                    ...
                    if ext_header.get_Excapsulating_Security_Payload() is not None:
                        ...
                        if excapsulating_security_payload.get_Security_Parameters_Index() is not None: excapsulating_security_payload_dict['security_parameters_index'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Security_Parameters_Index())
                        if excapsulating_security_payload.get_Sequence_Number() is not None: excapsulating_security_payload_dict['sequence_number'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Sequence_Number())
                        if excapsulating_security_payload.get_Payload_Data() is not None: excapsulating_security_payload_dict['payload_data'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Payload_Data())
                        if excapsulating_security_payload.get_Padding() is not None: excapsulating_security_payload_dict['padding'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Padding())
                        if excapsulating_security_payload.get_Padding_Len() is not None: excapsulating_security_payload_dict['padding_len'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Padding_Len())
                        if excapsulating_security_payload.get_Next_Header() is not None: excapsulating_security_payload_dict['security_parameters_index'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Security_Parameters_Index())
                        if excapsulating_security_payload.get_Authenication_Data() is not None: excapsulating_security_payload_dict['authenication_data'] = baseobjectattribute.dict_from_object(excapsulating_security_payload.get_Authenication_Data())
        ...
        if internet_layer.get_ICMPv6() is not None:
            ...
            if icmpv6.get_ICMPv6_Header() is not None:
                ...
                icmpv6_header_dict = {}
                if icmpv6_header.get_Type() is not None: icmpv6_header_dict['type'] = baseobjectattribute.dict_from_object(icmpv6_header.get_Type())
                if icmpv6_header.get_Code() is not None: icmpv6_header_dict['code'] = baseobjectattribute.dict_from_object(icmpv6_header.get_Code())
                if icmpv6_header.get_Checksum() is not None: icmpv6_header_dict['checksum'] = baseobjectattribute.dict_from_object(icmpv6_header.get_Checksum())
            ...
            if icmpv6.get_Error_Msg() is not None:
                ...
                if error_msg.get_Packet_Too_Big() is not None:
                    ...
                    if packet_too_big.get_MTU() is not None: packet_too_big_dict['mtu'] = baseobjectattribute.dict_from_object(packet_too_big.get_MTU())
                ...
                if error_msg.get_Parameter_Problem() is not None:
                    ...
                    if parameter_problem.get_Pointer() is not None: parameter_problem_dict['pointer'] = baseobjectattribute.dict_from_object(parameter_problem.get_Pointer())
                    error_msg_dict['parameter_problem'] = parameter_problem_dict
                if error_msg.get_Invoking_Packet() is not None: error_msg_dict['invoking_packet'] = baseobjectattribute.dict_from_object(error_msg.get_Invoking_Packet())
    ...
    def __parse_transport_layer(cls, transport_layer):
        ...
        if transport_layer.get_TCP() is not None:
            ...
            if tcp.get_TCP_Header() is not None:
                ...
                tcp_header_dict = {}
                if tcp_header.get_Src_Port() is not None: tcp_header_dict['src_port'] = port_object.dict_from_object(tcp_header.get_Src_Port())
                if tcp_header.get_Dest_Port() is not None: tcp_header_dict['dest_port'] = port_object.dict_from_object(tcp_header.get_Dest_Port())
                if tcp_header.get_Seq_Num() is not None: tcp_header_dict['seq_num'] = baseobjectattribute.dict_from_object(tcp_header.get_Seq_Num())
                if tcp_header.get_ACK_Num() is not None: tcp_header_dict['ack_num'] = baseobjectattribute.dict_from_object(tcp_header.get_ACK_Num())
                if tcp_header.get_Data_Offset() is not None: tcp_header_dict['data_offset'] = baseobjectattribute.dict_from_object(tcp_header.get_Data_Offset())
                if tcp_header.get_Reserved() is not None: tcp_header_dict['reserved'] = baseobjectattribute.dict_from_object(tcp_header.get_Reserved())
                ...
                if tcp_header.get_Window() is not None: tcp_header_dict['window'] = baseobjectattribute.dict_from_object(tcp_header.get_Window())
                if tcp_header.get_Checksum() is not None: tcp_header_dict['checksum'] = baseobjectattribute.dict_from_object(tcp_header.get_Checksum())
        ...
        if transport_layer.get_UDP() is not None:
            ...
            if udp.get_UDP_Header() is not None:
                ...
                udp_header_dict = {}
                if udp_header.get_SrcPort() is not None: udp_header_dict['srcport'] = port_object.dict_from_object(udp_header.get_SrcPort())
                if udp_header.get_DestPort() is not None: udp_header_dict['destport'] = port_object.dict_from_object(udp_header.get_DestPort())
