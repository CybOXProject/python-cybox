...
class X509V3Extensions(cybox.Entity):
    ...
    def from_dict(x509_v3_extensions_dict):
        ...
        x509_v3_extensions.basic_constraints = String.from_dict(x509_v3_extensions_dict.get('basic_constraints'))
        x509_v3_extensions.name_constraints = String.from_dict(x509_v3_extensions_dict.get('name_constraints'))
        x509_v3_extensions.policy_constraints = String.from_dict(x509_v3_extensions_dict.get('policy_constraints'))
        x509_v3_extensions.key_usage = String.from_dict(x509_v3_extensions_dict.get('key_usage'))
        x509_v3_extensions.extended_key_usage = String.from_dict(x509_v3_extensions_dict.get('extended_key_usage'))
        x509_v3_extensions.subject_key_identifier = String.from_dict(x509_v3_extensions_dict.get('subject_key_identifier'))
        x509_v3_extensions.authority_key_identifier = String.from_dict(x509_v3_extensions_dict.get('authority_key_identifier'))
        x509_v3_extensions.subject_alternative_name = String.from_dict(x509_v3_extensions_dict.get('subject_alternative_name'))
        x509_v3_extensions.issuer_alternative_name = String.from_dict(x509_v3_extensions_dict.get('issuer_alternative_name'))
        x509_v3_extensions.subject_directory_attributes = String.from_dict(x509_v3_extensions_dict.get('subject_directory_attributes'))
        x509_v3_extensions.crl_distribution_points = String.from_dict(x509_v3_extensions_dict.get('crl_distribution_points'))
        x509_v3_extensions.inhibit_any_policy = NonNegativeInteger.from_dict(x509_v3_extensions_dict.get('inhibit_any_policy'))
        x509_v3_extensions.private_key_usage_period = Validity.from_dict(x509_v3_extensions_dict.get('private_key_usage_period'))
        x509_v3_extensions.certificate_policies = String.from_dict(x509_v3_extensions_dict.get('certificate_policies'))
    ...
    def from_obj(x509_v3_extensions_obj):
        if not x509_v3_extensions_obj:
            return None
        x509_v3_extensions_ = X509V3Extensions()
        x509_v3_extensions.basic_constraints = String.from_obj(x509_v3_extensions_obj.get_Basic_Constraints())
        x509_v3_extensions.name_constraints = String.from_obj(x509_v3_extensions_obj.get_Name_Constraints())
        x509_v3_extensions.policy_constraints = String.from_obj(x509_v3_extensions_obj.get_Policy_Constraints())
        x509_v3_extensions.key_usage = String.from_obj(x509_v3_extensions_obj.get_Key_Usage())
        x509_v3_extensions.extended_key_usage = String.from_obj(x509_v3_extensions_obj.get_Extended_Key_Usage())
        x509_v3_extensions.subject_key_identifier = String.from_obj(x509_v3_extensions_obj.get_Subject_Key_Identifier())
        x509_v3_extensions.authority_key_identifier = String.from_obj(x509_v3_extensions_obj.get_Authority_Key_Identifier())
        x509_v3_extensions.subject_alternative_name = String.from_obj(x509_v3_extensions_obj.get_Subject_Alternative_Name())
        x509_v3_extensions.issuer_alternative_name = String.from_obj(x509_v3_extensions_obj.get_Issuer_Alternative_Name())
        x509_v3_extensions.subject_directory_attributes = String.from_obj(x509_v3_extensions_obj.get_Subject_Directory_Attributes())
        x509_v3_extensions.crl_distribution_points = String.from_obj(x509_v3_extensions_obj.get_CRL_Distribution_Points())
        x509_v3_extensions.inhibit_any_policy = NonNegativeInteger.from_obj(x509_v3_extensions_obj.get_Inhibit_Any_Policy())
        x509_v3_extensions.private_key_usage_period = Validity.from_obj(x509_v3_extensions_obj.get_Private_Key_Usage_Period())
        x509_v3_extensions.certificate_policies = String.from_obj(x509_v3_extensions_obj.get_Certificate_Policies())
        x509_v3_extensions.policy_mappings = String.from_obj(x509_v3_extensions_obj.get_Policy_Mappings())
        return x509_v3_extensions_
