...
class email_object(object):
            ...
            if key == 'header':
                ...
                for headername, headervalue in value.items():
                    ...
                    if headername == 'in_reply_to':
                        header.set_In_Reply_To(baseobjectattribute.object_from_dict(common_types_binding.StringObjectAttributeType(datatype="String"), headervalue))
    ...
    def dict_from_object(cls, defined_object):
        ...
        if defined_object.get_Attachments() is not None:
            ...
            attachment_list = []
            for file in files:
                attachment_list.append(file_object.dict_from_object(file))
        ...
        if defined_object.get_Header() is not None:
            ...
            if defined_object.get_In_Reply_To() is not None:
                defined_object_dict['header']['in_reply_to'] = baseobjectattribute.dict_from_object(defined_object.get_In_Reply_To())
            if defined_object.get_Message_ID() is not None:
                defined_object_dict['header']['message_id'] = baseobjectattribute.dict_from_object(defined_object.get_Message_ID())
        ...
        if defined_object.get_Optional_Header() is not None:
            ...
            if defined_object.get_Boundary() is not None:
                defined_object_dict['optional_header']['boundary'] = baseobjectattribute.dict_from_object(defined_object.get_Boundary())
            if defined_object.get_Content_Type() is not None:
                defined_object_dict['optional_header']['content_type'] = baseobjectattribute.dict_from_object(defined_object.get_Content_Type())
            if defined_object.get_MIME_Version() is not None:
                defined_object_dict['optional_header']['mime_version'] = baseobjectattribute.dict_from_object(defined_object.get_MIME_Version())
            if defined_object.get_Precedence() is not None:
                defined_object_dict['optional_header']['precedence'] = baseobjectattribute.dict_from_object(defined_object.get_Precedence())
        ...
        if defined_object.get_Raw_Body() is not None:
            defined_object_dict['raw_body'] = baseobjectattribute.dict_from_object(defined_object.get_Raw_Body())
        if defined_object.get_Raw_Header() is not None:
            defined_object_dict['raw_header'] = baseobjectattribute.dict_from_object(defined_object.get_Raw_Header())
        if defined_object.get_Email_Server() is not None:
            defined_object_dict['email_server'] = baseobjectattribute.dict_from_object(defined_object.get_Email_Server())
