...
class SMSMessageObjectType(cybox_common.ObjectPropertiesType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='SMSMessageObj:', name_='SMSMessageObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='SMSMessageObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='SMSMessageObj:', name_='SMSMessageObjectType'):
        super(SMSMessageObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='SMSMessageObjectType')
        if self.is_premium is not None and 'is_premium' not in already_processed:
            already_processed.add('is_premium')
            outfile.write(' is_premium="%s"' % self.gds_format_boolean(self.is_premium, input_name='is_premium'))
    def exportChildren(self, outfile, level, namespace_='SMSMessageObj:', name_='SMSMessageObjectType', fromsubclass_=False, pretty_print=True):
        super(SMSMessageObjectType, self).exportChildren(outfile, level, 'SMSMessageObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Sender_Phone_Number is not None:
            self.Sender_Phone_Number.export(outfile, level, 'SMSMessageObj:', name_='Sender_Phone_Number', pretty_print=pretty_print)
        if self.Recipient_Phone_Number is not None:
            self.Recipient_Phone_Number.export(outfile, level, 'SMSMessageObj:', name_='Recipient_Phone_Number', pretty_print=pretty_print)
        if self.Sent_DateTime is not None:
            self.Sent_DateTime.export(outfile, level, 'SMSMessageObj:', name_='Sent_DateTime', pretty_print=pretty_print)
        if self.Body is not None:
            self.Body.export(outfile, level, 'SMSMessageObj:', name_='Body', pretty_print=pretty_print)
        if self.Length is not None:
            self.Length.export(outfile, level, 'SMSMessageObj:', name_='Length', pretty_print=pretty_print)
        if self.Size is not None:
            self.Size.export(outfile, level, 'SMSMessageObj:', name_='Size', pretty_print=pretty_print)
        if self.Encoding is not None:
            self.Encoding.export(outfile, level, 'SMSMessageObj:', name_='Encoding', pretty_print=pretty_print)
        if self.Bits_Per_Character is not None:
            self.Bits_Per_Character.export(outfile, level, 'SMSMessageObj:', name_='Bits_Per_Character', pretty_print=pretty_print)
        if self.User_Data_Header is not None:
            self.User_Data_Header.export(outfile, level, 'SMSMessageObj:', name_='User_Data_Header', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="SMS_Message",
        namespacedef_='')
    return rootObj
