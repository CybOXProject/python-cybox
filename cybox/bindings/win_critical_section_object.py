...
#
# Generated Mon Apr 08 15:29:27 2013 by generateDS.py version 2.9a.
#
...
class WindowsCriticalSectionObjectType(cybox_common.ObjectPropertiesType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='WinCriticalSectionObj:', name_='WindowsCriticalSectionObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='WindowsCriticalSectionObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='WinCriticalSectionObj:', name_='WindowsCriticalSectionObjectType'):
        super(WindowsCriticalSectionObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='WindowsCriticalSectionObjectType')
    def exportChildren(self, outfile, level, namespace_='WinCriticalSectionObj:', name_='WindowsCriticalSectionObjectType', fromsubclass_=False, pretty_print=True):
        super(WindowsCriticalSectionObjectType, self).exportChildren(outfile, level, 'WinCriticalSectionObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
GDSClassesMapping = {
    ...
    'Windows_Critical_Section': WindowsCriticalSectionObjectType,
