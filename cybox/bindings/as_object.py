...
class ASObjectType(cybox_common.ObjectPropertiesType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='ASObj:', name_='ASObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ASObjectType')
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='ASObj:', name_='ASObjectType'):
        super(ASObjectType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='ASObjectType')
    def exportChildren(self, outfile, level, namespace_='ASObj:', name_='ASObjectType', fromsubclass_=False, pretty_print=True):
        super(ASObjectType, self).exportChildren(outfile, level, 'ASObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Number is not None:
            self.Number.export(outfile, level, 'ASObj:', name_='Number', pretty_print=pretty_print)
        if self.Name is not None:
            self.Name.export(outfile, level, 'ASObj:', name_='Name', pretty_print=pretty_print)
        if self.Handle is not None:
            self.Handle.export(outfile, level, 'ASObj:', name_='Handle', pretty_print=pretty_print)
        if self.Regional_Internet_Registry is not None:
            self.Regional_Internet_Registry.export(outfile, level, 'ASObj:', name_='Regional_Internet_Registry', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="AS",
        namespacedef_='')
    return rootObj
