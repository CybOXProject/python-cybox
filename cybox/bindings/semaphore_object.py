...
#
# Generated Mon Apr 08 15:29:10 2013 by generateDS.py version 2.9a.
#
...
class SemaphoreObjectType(cybox_common.ObjectPropertiesType):
    ...
    def __init__(self, object_reference=None, Custom_Properties=None, named=None, Current_Count=None, Maximum_Count=None, Name=None):
        super(SemaphoreObjectType, self).__init__(object_reference, Custom_Properties, )
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='SemaphoreObj:', name_='SemaphoreObjectType'):
        ...
        if self.named is not None and 'named' not in already_processed:
            ...
            outfile.write(' named="%s"' % self.gds_format_boolean(self.named, input_name='named'))
