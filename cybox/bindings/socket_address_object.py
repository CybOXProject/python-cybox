...
class SocketAddressObjectType(cybox_common.ObjectPropertiesType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='SocketAddressObj:', name_='SocketAddressObjectType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='SocketAddressObj:', name_='SocketAddressObjectType'):
    ...
    def exportChildren(self, outfile, level, namespace_='SocketAddressObj:', name_='SocketAddressObjectType', fromsubclass_=False, pretty_print=True):
        super(SocketAddressObjectType, self).exportChildren(outfile, level, 'SocketAddressObj:', name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
