...
This module depends on the cybox_helper code found at
the MAEC GitHub project: 
https://github.com/MAECProject/Tools/tree/development/API/cybox_helper
'''
...
def create_ipv4_observable(ipv4_address):
    ...
    ipv4_object = address_helper.create_from_dict({'address_value':ipv4_address})
