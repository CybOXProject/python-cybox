...
def create_from_dict(element_object, element_dict):
    """Create the ObjectAttributeType object representation from an input dictionary"""
...
def parse_into_dict(element):
    """Parse and return a dictionary for an ObjectAttributeType"""
    element_dict = {}
